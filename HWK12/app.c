        ...
        case APP_STATE_MOUSE_EMULATE:
            ...
            if (!appData.isMouseReportSendBusy) {
                ...
                /* Create the mouse report */
                 if(real_data[4] > 0 && real_data[4] < 5000){
                     moveY = 0;
                     appData.yCoordinate = (int8_t) 0;
                 }
                 else{
                ...
                if(real_data[5] > 0 && real_data[5] < 5000){
                    moveX = 0;
                    appData.xCoordinate = (int8_t) 0;
                }
                else{
                ...
                if(moveY==1 && moveX ==0){
                    LATAbits.LATA4 = 1;
                    if(count>9 && real_data[4] > 5000){ //straight movement up
                        appData.yCoordinate = (int8_t) -1;
                        count = 0;
                    }
                    else if(count>9 && real_data[4] < -5000) { //straight movement down
                        appData.yCoordinate = (int8_t) 1;
                        count = 0;
                    }
                }
                ...
                if(moveX==1 && moveY ==0){ 
                    LATAbits.LATA4 = 1;
                    if(count>9 && real_data[5] > 5000){ //straight movement right
                        appData.xCoordinate = (int8_t) 1;
                        count = 0;
                    }
                    else if(count>9 && real_data[5] < -5000){ //straight movement left
                        appData.xCoordinate = (int8_t) -1;
                        count = 0;
                    }
                }
                ...
                if(moveX==1 && moveY ==1){
                    ...
                    if(count>9 && real_data[4] > 5000){ //straight movement right
                        appData.yCoordinate = (int8_t) -1;
                        count = 0;
                    }
                    else if(count>9 && real_data[4] < -5000){ //straight movement left
                        appData.yCoordinate = (int8_t) 1;
                        count = 0;
                        }  
                }
